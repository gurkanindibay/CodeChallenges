...
public class FraudelentActivityNotificationsSolutionFromDiscussion {
    ...
    private static int activityNotifications(int[] arr, int d ) {
        int total = 0;
    ...
    public static  int showingNotifications() {
    ...
    public static void main(String[] args){
        System.out.println(showingNotifications());
    }
}
